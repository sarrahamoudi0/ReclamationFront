...
public class JwtService {
    ...
    private long jwtExpiration; // en millisecondes (par exemple : 86400000 pour 1 jour)
    ...
    private Key getSignInKey() {
        // Decode the base64 string and ensure URL-safe decoding is used
        byte[] keyBytes = Decoders.BASE64URL.decode(secretKey);  // URL-safe decoding
